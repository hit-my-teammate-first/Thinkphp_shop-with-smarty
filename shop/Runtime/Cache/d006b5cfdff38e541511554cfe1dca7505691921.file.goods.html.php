<?php /* Smarty version Smarty-3.1.6, created on 2018-03-16 18:54:14
         compiled from "C:/wamp/www/tp/shop/Home/View\Goods\goods.html" */ ?>
<?php /*%%SmartyHeaderCode:172285aa6065d020474-88862591%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd006b5cfdff38e541511554cfe1dca7505691921' => 
    array (
      0 => 'C:/wamp/www/tp/shop/Home/View\\Goods\\goods.html',
      1 => 1521197651,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172285aa6065d020474-88862591',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5aa6065ded529',
  'variables' => 
  array (
    'mbx' => 0,
    's' => 0,
...
<?php if ($_valid && !is_callable('content_5aa6065ded529')) {function content_5aa6065ded529($_smarty_tpl) {?><!DOCTYPE html>
...
/basic/css/demo.css" rel="stylesheet" type="text/css" />
		<link type="text/css" href="<?php echo @HOME_URL;?>
/css/optstyle.css" rel="stylesheet" />
		<link type="text/css" href="<?php echo @HOME_URL;?>
/css/style.css" rel="stylesheet" />

		<script type="text/javascript" src="<?php echo @HOME_URL;?>
/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="<?php echo @HOME_URL;?>
/basic/js/quick_links.js"></script>

		<script type="text/javascript" src="<?php echo @HOME_URL;?>
/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		<script type="text/javascript" src="<?php echo @HOME_URL;?>
/js/jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="<?php echo @HOME_URL;?>
...
/Index/index">首页</a></li>
 ...
 $_from = $_smarty_tpl->tpl_vars['mbx']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['s']->key => $_smarty_tpl->tpl_vars['s']->value){
$_smarty_tpl->tpl_vars['s']->_loop = true;
?>
					<li><a href="#"><?php echo $_smarty_tpl->tpl_vars['s']->value['cat_name'];?>
></a></li>
                                        <?php } ?>
				</ol>
				<div class="scoll">
...
/images/01.jpg"><img src="<?php echo @HOME_URL;?>
/images/01_mid.jpg" alt="细节展示放大镜特效" rel="<?php echo @HOME_URL;?>
/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="<?php echo @HOME_URL;?>
/images/01_small.jpg" mid="<?php echo @HOME_URL;?>
/images/01_mid.jpg" big="<?php echo @HOME_URL;?>
/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="<?php echo @HOME_URL;?>
/images/02_small.jpg" mid="<?php echo @HOME_URL;?>
/images/02_mid.jpg" big="<?php echo @HOME_URL;?>
/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="<?php echo @HOME_URL;?>
/images/03_small.jpg" mid="<?php echo @HOME_URL;?>
/images/03_mid.jpg" big="<?php echo @HOME_URL;?>
/images/03.jpg"></a>
									</div>
								</li>
							</ul>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1><?php echo $_smarty_tpl->tpl_vars['goodsinfo']->value['goods_name'];?>
</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price"><?php echo $_smarty_tpl->tpl_vars['goodsinfo']->value['goods_price'];?>
</b>  </dd>                                 
								</li>
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<input id="buy_num" name="" type="text" value="1" style="width:30px;" />
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="buy" title="点此按钮到下一步确认购买信息"onclick='addcart(a)' href="#">立即购买</a>
								</div>
							</li>
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="addcar" title="加入购物车"  href="#"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
                 <script>
                    ...
                    $('#addcar').click(function(){
                         data ={ "goods_id":"<?php echo $_smarty_tpl->tpl_vars['goodsinfo']->value['goods_id'];?>
","buy_num":$("#buy_num").val() };
                         $.post('<?php echo @__CONTROLLER__;?>
/gwc',data,function(msg,status){
                                if(msg){
                                    alert("添加购物车成功");
                                }
                         })
				...
				<div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="<?php echo @HOME_URL;?>
/images/cp.jpg"></a>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="<?php echo @HOME_URL;?>
/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<div class="attr-list-hd tm-clear">
											<h4><?php echo $_smarty_tpl->tpl_vars['goodsinfo']->value['goods_brief'];?>
</h4>
                                                                                </div>
									</div>
                                                                </div>
...
?>
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="<?php echo @HOME_URL;?>
/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
											...
											<div class="am-comment-main">
												...
												<header class="am-comment-hd">
													...
													<div class="am-comment-meta">
														...
														<!-- 评论者 -->
														评论于
														<time datetime=""><?php echo $_smarty_tpl->tpl_vars['com']->value['pubtime'];?>
</time>
													</div>
												</header>
									...
									<ul class="am-pagination am-pagination-right">
										...
										<li class="am-active"><a href="#"><?php echo $_smarty_tpl->tpl_vars['page']->value;?>
</a></li>
